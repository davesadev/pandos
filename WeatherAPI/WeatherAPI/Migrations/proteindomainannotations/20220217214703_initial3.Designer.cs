...
namespace WeatherAPI.Migrations.proteindomainannotations
{
    ...
    [Migration("20220217214703_initial3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeatherAPI.Models.Pdb", b =>
                {
            ...
            modelBuilder.Entity("WeatherAPI.Models.PdbChain", b =>
                {
            ...
            modelBuilder.Entity("WeatherAPI.Models.PdbChainDatum", b =>
                {
            ...
            modelBuilder.Entity("WeatherAPI.Models.Uniprot", b =>
                {
                    b.Property<int>("UniprotId")
                        .HasColumnType("int")
                        .HasColumnName("uniprot_id");
            ...
            modelBuilder.Entity("WeatherAPI.Models.Pdb", b =>
                {
                    b.HasOne("WeatherAPI.Models.Uniprot", "Uniprot")
                        .WithMany("Pdbs")
            ...
            modelBuilder.Entity("WeatherAPI.Models.PdbChain", b =>
                {
                    b.HasOne("WeatherAPI.Models.Pdb", "Pdb")
                        .WithMany("PdbChains")
                        .HasForeignKey("PdbId")
            ...
            modelBuilder.Entity("WeatherAPI.Models.PdbChainDatum", b =>
                {
                    b.HasOne("WeatherAPI.Models.PdbChain", "PdbChain")
